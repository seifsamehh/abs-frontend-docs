...
keywords: ["authentication", "nextauth", "auth", "rbac", "session", "jwt"]
---
...
- 🛡️ [Security Reference](/docs/reference/security) - Security policies
- 📡 [Data Fetching](/docs/guides/data-fetching) - Authenticated API calls
- 📝 [Forms Guide](/docs/guides/forms) - Build login forms
